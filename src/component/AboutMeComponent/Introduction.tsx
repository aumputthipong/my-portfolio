...
const Introduction = () => {
  return (
    <div className="border-2 border-gray-300 rounded-2xl p-6 max-w-4xl mx-auto relative  overflow-hidden bg-white  shadow-l hover:shadow-xl transition-all duration-500  ">
        ...
        <div className=" gap-8 flex items-center text-center md:text-left md:items-start">
          ...
          <div className="">
            ...
            <p className="text-gray-600 leading-relaxed text-sm py-2">
              Passionate and self-motivated web developer with a focus on
              software engineering and full-stack development. Recently
              graduated from the Faculty of Information Technology KMITL. Eager
              to keep learning and improving. Seeking an opportunity to
              contribute and grow in a development team.
            </p>
